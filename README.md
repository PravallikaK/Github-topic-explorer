...
* Open the page by running the command `npm run start` or `npm start`
...
* User can change the topic by typing in the Search Bar on the top right and click on the `search`button. the query search topic will be shown on top of the results.
* User can click on each related topic to see sub-topics under
* On initial load the application shows all the list since there is no perticular information to search
